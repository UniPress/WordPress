...
class WPAutomaticUpdater {
    ...
    public function run() {
        ...
        remove_action( 'upgrader_process_complete', array('WordPress\Admin\LanguagePackUpgrader', 'async_upgrade' ), 20 );
        ...
        // (CoreUpgrader checks for core updates)
        wp_update_themes();  // Check for Theme updates
        wp_update_plugins(); // Check for Plugin updates
