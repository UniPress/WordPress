 ...
 * @access private
 */
class WPTermsListTable extends WPListTable
{
    ...
    function column_name($tag)
    {
        ...
        $out = '<strong><a class="row-title" href="' . $edit_link . '" title="' . esc_attr(
                sprintf(__('Edit &#8220;%s&#8221;'), $name)
            ) . '">' . $name . '</a></strong><br />';
        ...
        if (current_user_can($tax->cap->delete_terms) && $tag->term_id != $default_term) {
            $actions['delete'] = "<a class='delete-tag' href='" . wp_nonce_url(
                ...
                <tr id="inline-edit" class="inline-edit-row" style="display: none">
                    <td colspan="<?php echo $this->get_column_count(); ?>" class="colspanchange">
                        ...
                        <p class="inline-edit-save submit">
                            <a accesskey="c" href="#inline-edit" class="cancel button-secondary alignleft"><?php _e(
                                    'Cancel'
                                ); ?></a>
