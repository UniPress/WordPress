...
class WPAdminBar {
	...
	public function __get( $name ) {
		switch ( $name ) {
			case 'proto' :
				...
				break;
			case 'menu' :
				_deprecated_argument( 'WPAdminBar', '3.3', 'Modify admin bar nodes with WPAdminBar::get_node(), WPAdminBar::add_node(), and WPAdminBar::remove_node(), not the <code>menu</code> property.' );
	...
	public function initialize() {
		...
		/**
		 * Fires after WPAdminBar is initialized.
		 *
		 * @since 3.1.0
		 */
	...
	public function recursive_render( $id, $node ) {
		_deprecated_function( __METHOD__, '3.3', 'WP_Admin_bar::render(), WPAdminBar::_render_item()' );
