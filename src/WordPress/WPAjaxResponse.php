...
class WPAjaxResponse {
	...
	/**
	 * Constructor - Passes args to {@link WPAjaxResponse::add()}.
	 *
	 * @since 2.1.0
	 ...
	 * also possible to pass a WPError object in either the 'id' or 'data'
	 ...
	 * 'id' argument can be WPError or an integer.
