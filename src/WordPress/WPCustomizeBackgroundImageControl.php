 ...
 * @since 3.4.0
 */
class WPCustomizeBackgroundImageControl extends WPCustomizeImageControl {

    /**
     * Constructor.
     *
     * @since 3.4.0
     * @uses WPCustomizeImageControl::__construct()
     *
     * @param WPCustomizeManager $manager
     */
    ...
    /**
     * @since 3.4.0
     * @uses WPCustomizeImageControl::print_tab_image()
     */
