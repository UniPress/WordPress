 ...
 * @since 3.4.0
 */
final class WPCustomizeManager {
	protected $theme;
	...
	/**
	 * Decode the $_POST attribute used to override the WPCustomizeSetting values.
	 *
	 * @since 3.4.0
	 *
	 * @param mixed $setting A WPCustomizeSetting derived object
	...
	public function add_setting( $id, $args = array() ) {
		if ( is_a( $id, 'WPCustomizeSetting' ) )
			$setting = $id;
		else
			$setting = new WPCustomizeSetting( $this, $id, $args );
	...
	public function add_section( $id, $args = array() ) {
		if ( is_a( $id, 'WPCustomizeSection' ) )
			$section = $id;
		else
			$section = new WPCustomizeSection( $this, $id, $args );
	...
	public function add_control( $id, $args = array() ) {
		if ( is_a( $id, 'WPCustomizeControl' ) )
			$control = $id;
		else
			$control = new WPCustomizeControl( $this, $id, $args );
	...
	public function register_controls() {
		...
		$this->add_control( new WPCustomizeColorControl( $this, 'header_textcolor', array(
		...
		$this->add_control( new WPCustomizeColorControl( $this, 'background_color', array(
		...
		$this->add_setting( new WPCustomizeFilterSetting( $this, 'header_image', array(
			'default'        => get_theme_support( 'custom-header', 'default-image' ),
			'theme_supports' => 'custom-header',
		) ) );

		$this->add_setting( new WPCustomizeHeaderImageSetting( $this, 'header_image_data', array(
			// 'default'        => get_theme_support( 'custom-header', 'default-image' ),
			'theme_supports' => 'custom-header',
		) ) );
		...
		$this->add_setting( new WPCustomizeBackgroundImageSetting( $this, 'background_image_thumb', array(
			'theme_supports' => 'custom-background',
		) ) );

		$this->add_control( new WPCustomizeBackgroundImageControl( $this ) );
