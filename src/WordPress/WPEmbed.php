...
class WPEmbed {
	 ...
	 * an AJAX request that will call WPEmbed::cache_oembed().
	 */
...
<?php
	 ...
	 * If none of the regex matches and it's enabled, then the URL will be given to the {@link WPoEmbed} class.
	 *
	 * @uses wp_oembed_get()
	 * @uses wp_parse_args()
	 * @uses wp_embed_defaults()
	 * @uses WPEmbed::maybe_make_link()
	 * @uses get_option()
	 * @uses author_can()
	 * @uses wp_cache_get()
	 * @uses wp_cache_set()
	...
	function shortcode( $attr, $url = '' ) {
		...
		if ( ! empty( $this->post_ID ) ) // Potentially set by WPEmbed::cache_oembed()
	...
	/**
	 * Passes any unlinked URLs that are on their own line to {@link WPEmbed::shortcode()} for potential embedding.
	 *
	 * @uses WPEmbed::autoembed_callback()
	 *
	...
	/**
	 * Callback function for {@link WPEmbed::autoembed()}.
	 *
	 * @uses WPEmbed::shortcode()
	 *
