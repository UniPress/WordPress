...
class WPObjectCache {
     ...
     *
     * @uses WPObjectCache::_exists Checks to see if the cache already has data.
     * @uses WPObjectCache::set Sets the data after the checking the cache
     *		contents existence.
     *
     * @since 2.0.0
     *
     ...
     *
     * @since 2.0.8
     * @return null|WPObjectCache If cache is disabled, returns null.
     */
