 ...
 * Unregister a widget
 *
 * Unregisters a Widget widget. Useful for unregistering default widgets.
 ...
 * @param string $id_base Optional, the base ID of a widget created by extending Widget.
...
function the_widget($widget, $instance = array(), $args = array()) {
	...
	if ( !is_a($widget_obj, '\WordPress\Widget\Widget') )
		return;
