...
/**
 * This class must be extended for each widget and WPWidget::widget(), WPWidget::update()
 * and WPWidget::form() need to be over-ridden.
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 2.8
...
class WPWidget {
	...
	function widget($args, $instance) {
		die('function WPWidget::widget() must be over-ridden in a sub-class.');
	}
	...
	function WP_Widget( $id_base, $name, $widget_options = array(), $control_options = array() ) {
		WPWidget::__construct( $id_base, $name, $widget_options, $control_options );
	}
...
/**
 * Singleton that registers and instantiates WPWidget classes.
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 2.8
 ...
 *
 * @param string $widget_class The name of a class that extends WPWidget
 */
 ...
 * Unregister a widget
 *
 * Unregisters a WPWidget widget. Useful for unregistering default widgets.
 ...
 * $id_base is the first argument when extending WPWidget class
 ...
 * @param string $id_base Optional, the base ID of a widget created by extending WPWidget.
