 ...
 * via the xmlrpc_enabled filter found in WPXmlrpcServer::login().
 *
 * @package WordPress
 * @subpackage Publishing
 * @since 1.5.0
 */
class WPXmlrpcServer extends IXRServer {
	 ...
	 * @return mixed WPUser object if authentication passed, false otherwise
	 */
	 ...
	 * @since 1.5.0
	 * @deprecated 2.8.0
	 * @deprecated use WPXmlrpcServer::login
	...
	/**
	 * Convert a WordPress date string to an IXRDate object.
	 *
	 * @access protected
	 *
	 * @param string $date
	...
	/**
	 * Convert a WordPress GMT date string to an IXRDate object.
	 *
	 * @access protected
	 *
	 ...
	 * @access protected
	 *
	 * @param WPUser $user The unprepared user object
	 ...
	 * @uses wp_insert_post()
	 *
	 * @param WPUser $user The post author if post_author isn't set in $content_struct.
	 ...
	 * @since 2.2.0
	 *
	 * @param array $args Method parameters. See {@link WPXmlrpcServer::mw_newPost()}
	 * @return unknown
	 */
	 ...
	 *
	 * @param array $args Method parameters.
	 * @return array. Contains a collection of comments. See {@link WPXmlrpcServer::wp_getComment()} for a description of each item contents
	 */
	 ...
	 *  - password
	 *  - filter
	 * @return array. Contains a collection of media items. See {@link WPXmlrpcServer::wp_getMediaItem()} for a description of each item contents
	 */
