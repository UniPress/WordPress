 ...
 * Used internally by the {@link WPEmbed} class, but is designed to be generic.
 *
...
class WPoEmbed {
	...
	function _fetch_with_format( $provider_url_with_args, $format ) {
		...
		if ( 501 == wp_remote_retrieve_response_code( $response ) )
			return new WordPress\WPError( 'not-implemented' );
	...
	/**
	 * Converts a data object from {@link WPoEmbed::fetch()} and returns the HTML.
	 *
	 ...
	 * @param object $data Data object from WPoEmbed::data2html()
