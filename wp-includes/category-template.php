 ...
 * @return string|WPError Category name on success, WPError on failure.
 */
 ...
 * @uses Walker
 */
class Walker_Category extends \WordPress\Walker {
	/**
 ...
 * @uses Walker
 */
class Walker_CategoryDropdown extends \WordPress\Walker {
	/**
	 * @see Walker::$tree_type
	 * @since 2.1.0
	 * @var string
 ...
 * @return string|bool|WPError A list of tags on success, false or WPError on failure.
 */
 ...
 * @return array|bool|WPError Array of term objects on success, false or WPError on failure.
 */
 ...
 * @param string $sep Optional. Separate items using this.
 * @param string $after Optional. After list.
 * @return string|bool|WPError A list of terms on success, false or WPError on failure.
 */
